...
class BROV2ThrusterModel:
    ...
    * BlueRobotics T200 thruster 의 RPM-Thrust 다항식 사용 (MarineGym t200.py 기반).
    ...
    # ------------------------------------------------------------------
    _POS = torch.tensor([
        [ 0.14, -0.098,  0.00],   # T1: 전우 수평
        [ 0.14,  0.105,  0.00],   # T2: 전좌 수평
        [-0.14, -0.097,  0.00],   # T3: 후우 수평
        [-0.14,  0.104,  0.00],   # T4: 후좌 수평
        [ 0.129, -0.214,  0.061],   # T5: 전우 수직
        [ 0.129,  0.221,  0.061],   # T6: 전좌 수직
        [-0.111, -0.214,  0.061],   # T7: 후우 수직
        [-0.111,  0.221,  0.061],   # T8: 후좌 수직
